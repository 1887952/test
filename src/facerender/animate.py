...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        predictions_video = make_animation(source_image, source_semantics, target_semantics,
                                        ...
                                        yaw_c_seq, pitch_c_seq, roll_c_seq, use_exp = True,frame_num)
        ...
        if 'full' in preprocess.lower():
            ...
            tmp_path, new_audio_path = paste_pic(path, pic_path, crop_info, new_audio_path, full_video_path, extended_crop= True if 'ext' in preprocess.lower() else False)
